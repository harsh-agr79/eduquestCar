...
import ProjectsSection2 from './Sections/ProjectsSection2.js'
import ProjectsSection3 from './Sections/ProjectsSection3.js'
...
export default class World
{
    ...
    setSections()
    {
        ...
        this.sections.projects2 = new ProjectsSection2({
            ...options,
            x: 30,
            y: - 60
            // x: 0,
        ...
        this.container.add(this.sections.projects2.container)

         this.sections.projects3 = new ProjectsSection3({
            ...options,
            x: 30,
            y: - 90
            // x: 0,
        ...
        this.container.add(this.sections.projects3.container)
