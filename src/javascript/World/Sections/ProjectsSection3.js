        ...
        this.list = [
            {
                ...
                imageSources:
                [
                    './models/projects/biology/title.jpeg',
                ...
                floorTexture: this.resources.items.projectsBiologyTitleFloorTexture,
                link:
                {
                    href: '#',
                    x: 0,
            ...
            },
            {
                ...
                floorTexture: this.resources.items.projectsBiologyStudyFloorTexture,
                link:
                {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://mpo3.mypowerworld.com/rpgbio/',
                    x: - 4.8,
                    y: - 4,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                imageSources:
                [
                   './models/projects/biology/fpsb.png',
                ],
                floorTexture: this.resources.items.projectsFPSFloorTexture,
                link:
                {
                    href: "https://mpo3.mypowerworld.com/?fps=3&" + (userParam ? `user=${userParam}` : ""),
                    x: - 4.8,
                    y: - 2,
                    halfExtents:
                    {
