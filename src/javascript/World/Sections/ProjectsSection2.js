...
export default class ProjectsSection2
{
        ...
        this.list = [
            {
                ...
                imageSources:
                [
                     './models/projects/python/title.png'
                ...
                floorTexture: this.resources.items.projectsPythonTitleFloorTexture,
                link:
                {
                    href: '#',
                    x: 0,
            ...
            },
            {
                ...
                floorTexture: this.resources.items.projectsPythonStudyFloorTexture,
                link:
                {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://mpo3.mypowerworld.com/rpgpython/',
                    x: - 4.8,
                    y: - 4,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                imageSources:
                [
                    './models/projects/python/fpsb.png',
                ],
                floorTexture: this.resources.items.projectsFPSFloorTexture,
                link:
                {
                    href: "https://mpo3.mypowerworld.com/?fps=2&" + (userParam ? `user=${userParam}` : ""),
                    x: - 4.8,
                    y: - 2,
                    halfExtents:
                    {
