...
export default class Resources extends EventEmitter
{
    constructor()
    {
        ...
        this.loader.load([
            ...
            { name: 'crossroadsStaticFlag', source: './models/crossroads/static/flag.glb' },
            ...
            { name: 'projectsPhysicsStudyFloor', source: './models/projects/physics/studyM3.jpg', type: 'texture' },
            { name: 'projectsPythonStudyFloor', source: './models/projects/python/studyM.jpg', type: 'texture' },
            { name: 'projectsPythonTitleFloor', source: './models/projects/python/python.jpg', type: 'texture' },
            { name: 'projectsBiologyTitleFloor', source: './models/projects/biology/biology.png', type: 'texture' },
            { name: 'projectsBiologyStudyFloor', source: './models/projects/biology/studyM.png', type: 'texture' },
            { name: 'projectsEscRoomFloor', source: './models/projects/python/escroom.jpg', type: 'texture' },
            { name: 'projectsKnowClifFloor', source: './models/projects/python/KnowClif.png', type: 'texture' },
            { name: 'projectsRPGFloor', source: './models/projects/python/RPG.png', type: 'texture' },
            { name: 'projectsFPSFloor', source: './models/projects/python/FPS.png', type: 'texture' },
